		...
		<tbody>
			<tr>
				<td>
					...
					<table cellpadding="0" cellspacing="0" style="width:580px; margin:0 auto;">
						<tbody>
							<tr>

								<td style="background:#000; color:#fff; width:380px; padding:40px 30px;">
									...
									<table>
										...
										<tr>
											<td style="text-align:center;">
												<h1 style="color:#B59D60; font-family:'Trebuchet MS', sans-serif; font-weight:300; font-size:20px; line-height:1.2; text-transform:uppercase; margin-bottom:20px;">
													@lang('email_notvalid_title')
												</h1>
											</td>
										</tr>
								...
								<td style="width:200px;">
									<img src="{{asset('/assets/img/email-notvalid-image.jpg')}}?v2" alt="picture" width="200" height="630" style="vertical-align:middle;" />
								</td>
